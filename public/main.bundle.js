...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_angular_flash_message__ = __webpack_require__("../../../../angular-flash-message/dist/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_angular_flash_message___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_15_angular_flash_message__);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_15_angular_flash_message__["FlashMessageModule"],
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Mean Authentication Application</h1>\n  <p class=\"lead\">Welcome to MEAN Authentication Application build from scratch.</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['register']\">Register</a>\n    <a class=\"btn btn-success\" [routerLink]=\"['login']\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n    <p>A Rock solid Node.js/Express server using Moongose to organize models and query the database.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular-CLI</h3>\n    <p>Angular-CLI to Generate Components, services and more. Local Dev server and easy compilation.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n    <p>Full Featured authentication using JSON webtokens. Logins and store user data.</p>\n  </div>\n</div>\n\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authservice.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.success('Your are now Logged In.', { dalay: 3000, close: true });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMessage.danger(data.msg, { dalay: 3000, close: true });
...
module.exports = "<h2 class=\"page-header\">Registration Form</h2>\n<form (submit)=\"onRegisterSubmit()\">\n  <div class=\"form-group\">\n    <label for=\"name\">Name</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"name\" name=\"name\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"username\">Username</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"username\" name=\"username\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"email\">Email</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"email\" name=\"email\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"email\">Password</label>\n    <input type=\"pasword\" class=\"form-control\" [(ngModel)]=\"password\" name=\"password\">\n  </div>\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Submit\">\n</form>"
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authservice.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.warning('Successfully Registered', {
                    dalay: 3000,
                ...
                _this.flashMessage.warning('Somthing went wrong!', {
                    dalay: 3000,
                    generalClass: 'alert alert-danger',
                    close: true
                });
...
var AuthService = (function () {
    ...
    AuthService.prototype.loggedIn = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_3_angular2_jwt__["tokenNotExpired"])('access_token');
    };
